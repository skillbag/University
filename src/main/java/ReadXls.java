...
public class ReadXls {
    ...
    public static List<University> readXlsUniversities(String filePath) throws IOException {
        ...
        while (rows.hasNext()) {
            ...
            university.setId(new StringBuilder(currentRow.getCell(0).getStringCellValue()));
            university.setFullName(new StringBuilder(currentRow.getCell(1).getStringCellValue()));
            university.setShortName(new StringBuilder(currentRow.getCell(2).getStringCellValue()));
    ...
    public static List<Student> readXlsStudents(String filePath) throws IOException {
        ...
        while (rows.hasNext()) {
            ...
            student.setUniversityId(new StringBuilder(currentRow.getCell(0).getStringCellValue()));
            student.setFullName(new StringBuilder(currentRow.getCell(1).getStringCellValue()));
